...
export const INSTRUMENTS: InstrumentConfig[] = [
  ...
  // 나중에 추가:
  // { id: "guitar_7", label: "Guitar (7현)", strings: [35, 40, 45, 50, 55, 59, 64], fretCount: 15 },
  // { id: "bass_5",   label: "Bass (5현)",   strings: [23, 28, 33, 38, 43], fretCount: 15 },
  // { id: "bass_6",   label: "Bass (6현)",   strings: [23, 28, 33, 38, 43, 47], fretCount: 15 },
];
